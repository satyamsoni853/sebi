      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-left">
            <FadeIn>
              <div className="inline-block mb-6 px-3 py-1 border border-primary dark:border-blue-400 text-primary dark:text-blue-400 rounded-full text-xs font-bold tracking-wider uppercase bg-primary/5 dark:bg-blue-900/10">
          ...
          {/* Right Column: Trading Animation */}
